...
var _globalThis2 = _interopRequireDefault(
  require("@babel/runtime-corejs3/core-js/global-this"),
);
var _setTimeout2 = _interopRequireDefault(
  require("@babel/runtime-corejs3/core-js/set-timeout"),
);
var _find = _interopRequireDefault(
  require("@babel/runtime-corejs3/core-js/instance/find"),
);
var _values = _interopRequireDefault(
  require("@babel/runtime-corejs3/core-js/object/values"),
);
...
const ActiveRouteLoader = (_ref) => {
  let { path, spec, delay, params, whileLoadingPage, children } = _ref;
  ...
  const [renderedChildren, setRenderedChildren] = (0, _react.useState)(
    children,
  );
  ...
  (0, _react.useEffect)(() => {
    const startPageLoadTransition = async function (_ref2) {
      let { loader, name } = _ref2;
      let delay =
        arguments.length > 1 && arguments[1] !== undefined
          ? arguments[1]
          : DEFAULT_PAGE_LOADING_DELAY;
      ...
      if (isMounted() && name === waitingFor.current) {
        ...
        const renderedChildren =
          children !== null && children !== void 0 ? children : module.default;
        setRenderedChildren(renderedChildren); //FIXME: test this?
        setRenderedPath(path);
        setPageName(name);
      }
    };
    if (spec.name !== waitingFor.current) {
      ...
      setLoadingState((loadingState) => {
        ...
        if (!existingPage) {
          var _context;
          const pageState = (0, _find.default)(
            (_context = (0, _values.default)(loadingState)),
          ).call(_context, (state) => state?.specName === spec.name);
  ...
  if (_globalThis2.default.__REDWOOD__PRERENDERING) {
    ...
    return /*#__PURE__*/ _react.default.createElement(
      _.ParamsProvider,
      {
        ...
        _PageLoadingContext.PageLoadingContextProvider,
        {
          value: {
            loading: false,
          },
				...
				/*#__PURE__*/ _react.default.createElement(
          _ActivePageContext.ActivePageContextProvider,
          {
            value: {
