...
const ActiveRouteLoader = _ref => {
    ...
    if (spec.name !== waitingFor.current) {
      ...
      (0, _reactDom.unstable_batchedUpdates)(() => {
        ...
        setLoadingState(loadingState => {
          ...
          if (!existingPage) {
            var _context;
            const pageState = (0, _find.default)(_context = (0, _values.default)(loadingState)).call(_context, state => state?.specName === spec.name);
  ...
  if (_globalThis2.default.__REDWOOD__PRERENDERING) {
    ...
    const PageFromLoader = spec.loader().default;
  ...
  return /*#__PURE__*/_react.default.createElement(_.ParamsProvider, {
    ...
    value: {
      loadingState: renderedLoadingState
    }
  }, renderedChildren, renderedLoadingState[path]?.state === 'DONE' && /*#__PURE__*/_react.default.createElement("div", {
